...
module.exports = ({
  ...
  ${body({content: `
    ...
    <section class="flex flex-column justify-center items-center mw7 w-100 center ph3 ph0-ns">
        <div class="pv4">
          <h2 class="f2-ns fw4 measure tc">Want the best non-tech, start-up job delivered to your inbox?</h2>
          <p class="ph0 mh0 lh-copy tc">We collate and send you the best marketing jobs at the UK's best start-ups, every month. Oh and if you don't like it, you can unsubscribe in a click.</p>
          ${form({role})}
        </div>
        <div class="pv4 bt b--black-10">
          <h3 class="f3-ns fw4 measure tc">Past issues</h3>
