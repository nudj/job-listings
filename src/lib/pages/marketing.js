...
module.exports = () => {
  ...
  <section class="flex flex-column justify-center items-center mw7 w-100 center ph3 ph0-ns">
    <div class="pv4">
      ...
      <p class="lh-copy">Given the many different types of businesses that are starting up, there are jobs going for all types of marketers. So, whether you're a PPC wizard, a crafty content creator, a public relations guru or a jack-of-all-trades Growth Hacker there is probably an role waiting for you.</p>
    </div>
