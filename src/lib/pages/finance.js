  ...
  <section class="flex flex-column justify-center items-center mw7 w-100 center">
    ...
    <div class="bt b--black-10 pv4">
      ...
      <div class="bt b--black-10 pv4">
        ...
        <legend class="f5 fw6 ph0 mh0 lh-copy">We'll collate and send you the best finance jobs at the UK's best start-ups, every week. And unsubscribe in a click.</legend>
        ${form()}
      </div>
  </section>
  ${footer()}
