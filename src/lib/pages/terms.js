...
module.exports = () => {
  ...
  ${body({content: `
    ${nav()}
    <div class="mw7 center w-100 work-sans pv4 ph4">
      ...
      <h3 class="fw4">4. Accuracy of materials</h3>
      ...
      <p class="lh-copy">nudj has not reviewed all of the sites linked to this website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by nudj of the site. Use of any such linked website is at the user's own
        risk.</p>
      <h3 class="fw4">6. Modifications</h3>
      ...
      <h3 class="fw4">7. Governing Law</h3>
      ...
      <h2 class="f2 fw4">Privacy Policy</h2>
      ...
      <ul class="lh-copy">
        <li>We will collect personal information by lawful and fair means and with the knowledge or consent of the individual concerned.</li>
      ...
      <h2 class="f2 fw4">Contact Details & Address</h2>
      <p class="lh-copy">
        Robyn McGirl
        <br />2 Kensington Square
        <br />London
        <br />W8 5HP
        <br />UK
        <br /><a href="mailto:hello@nudj.co">hello@nudj.co</a>
      </p>
    </div>
    ${footer()}
    `
